...
#ifndef OPENCV_TEST__DENSE_MAPPING_SLAM_HPP_
#define OPENCV_TEST__DENSE_MAPPING_SLAM_HPP_
#include <iostream>
#include <vector>
#include <fstream>
...
bool updateDepthFilter_myself(Vector2d ref_pt,
                              Vector2d curr_pt,
                              SE3d T_C_R,
                              Vector2d epipolar_direction,
                              cv::Mat depth,
...
int slam_main(int argc, char **argv) {
  /*
  if (argc != 2) {
...
#endif //OPENCV_TEST__DENSE_MAPPING_SLAM_HPP_
